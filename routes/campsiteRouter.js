...
campsiteRouter.route('/:campsiteId/comments')
    ...
    .post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => { //This post request will be adding a new comment to the list of comments for a particular campsite
...
campsiteRouter.route('/:campsiteId/comments/:commentId')
    ...
    .put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {//this put request will update the text and rating fields of an existing comment
        Campsite.findById(req.params.campsiteId)
            .then(campsite => {
                if (campsite && campsite.comments.id(req.params.commentId)) { //making sure non-null/truthy value was returned for the campsite document & for the comment
